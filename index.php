...
$_SESSION['role'] = $row['role'];
    ...
    else if($row['username'] == $username and $row['userpassword'] == $password and $row['role'] == "Utilisateur"){
      ...
      <div class="card-body">
        ...
        <form action="" method="post">
          <div class="input-group mb-3">
            ...
            <!-- <input type="email" class="form-control" placeholder="E-mail" name="txt_email" required> -->
