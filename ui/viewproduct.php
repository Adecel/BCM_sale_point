                        ...
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <center><p class="list-group-item list-group-item-info"><b>DÉTAILS DU PRODUIT</b></p></center>  
                              ...
                              <li class="list-group-item"><b>Nom du produit</b><span class="badge badge-warning float-right">'.$row->product.'</span></li>
                              <li class="list-group-item"><b>Fournisseur</b> <span class="badge badge-success float-right">'.$row->Supplier.'</span></li>
                              <li class="list-group-item"><b>Unité</b> <span class="badge badge-success float-right">'.$row->unit.'</span></li>
                              <li class="list-group-item"><b>Catégorie</b> <span class="badge badge-success float-right">'.$row->category.'</span></li>
