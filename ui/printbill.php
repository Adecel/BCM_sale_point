...
$pdf->Cell(60,8,'Ets BCM',1,1,'C');


$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(60,5,'Telephone : (+242) 05-551-48-29',0,1,'C');
$pdf->Cell(60,5,'Adresse : Ngoyo Central',0,1,'C');
...
$pdf->Cell(20,4,'Facture No.:',0,0,'C');
...
$pdf->Cell(34,5,'PRODUIT',1,0,'C');
$pdf->Cell(7,5,'QTY',1,0,'C'); //7
$pdf->Cell(12,5,'PRIX',1,0,'C');  //12
